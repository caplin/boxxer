 ...
 * {@link caplin.component.ComponentLifecycleEvents} interface which defines the life cycle
 ...
 * {@link caplin.component.ComponentLifecycleEvents#onOpen} are the only methods the windowing environment will invoke.</p>
 *
 ...
 * layout are instantiated by the {@link caplin.component.ComponentFactory}. As such a
 * <code>Component</code> must be registered with the using the factory's
 * {@link caplin.component.ComponentFactory#registerComponent} method, passing
 ...
 * @deprecated
 * @see #setFrame
 * @param {caplin.component.container.Container} oContainer The container hosting this component. 
 */
 ...
 * 
 * @param {caplin.component.frame.ComponentFrame} oComponentFrame The frame enclosure that wraps this component.
 */
 ...
 * @throws {caplin.core.Error} if this method is not implemented by the subclass.
 */
caplin.component.Component.prototype.getElement = function()
{
	throw new caplin.core.Error(caplin.core.Error.UNIMPLEMENTED_INTERFACE, "Component.getElement() has not been implemented.");
};

/**
 * Invoked when the windowing environment needs to save the state of this component. It returns an
 * XML string representation of the state.
 *
 * <p>This method is compulsory, and must be implemented.</p>
 * 
 * <p>Example:</p>
 ...
 * };
 * caplin.implement(mybank.MyComponent, caplin.component.Component);
 * 
 ...
 * };
 * 
 * // other caplin.component.Component methods ...
 * 
...
caplin.component.Component.prototype.getSerializedState = function()
{
	throw new caplin.core.Error(caplin.core.Error.UNIMPLEMENTED_INTERFACE, "Component.getSerializedState() has not been implemented.");
};
